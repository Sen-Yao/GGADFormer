...
def get_split(num_nodes, labels, train_ratio, split_seed, val_ratio=0.1):
...
def run(args):
    ...
    idx_train, _, _ = get_split(
        features.shape[0], labels, args.train_ratio, args.data_split_seed
    )
    model = RHO(
