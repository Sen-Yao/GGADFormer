...
case "$gpu_index" in
  0|1|2|3) expected_trial_count=3 ;;
  4|5|6|7) expected_trial_count=2 ;;
  *)
...
task_root="/root/gpufree-data/linziyao/VecGAD-elliptic-bundle-factorial-019fb305"
...
export PROTOCOL_ID="elliptic-bundle-factorial-019fb305"
export PARENT_SWEEP_ID="k5lbpsg9"
