...
from utils import *
from rec_error_filter_utils import compute_rec_error_dominant, evaluate_with_rec_error_filter
    ...
    for epoch in range(args.num_epoch):
        ...
        if epoch % 5 == 0:
             ...
             if args.rec_error_filter_ratio < 1.0:
                 ...
                 rec_errors = compute_rec_error_dominant(model, features, adj, idx_test, device)
